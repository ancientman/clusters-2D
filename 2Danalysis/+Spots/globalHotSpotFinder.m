function [hotSpotStruct] = globalHotSpotFinder(im, nucPropStruct, thres, nucEl, spotEl, nucleusDetectMode, minNucSize, minSpotSize, clearBorder)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
